...
import ProfilePic from '../../assets/images/home/john-doe-image.png';

const Testimonial = () => {
    return (
        <div className="work-section-wrapper" id="testimonials">
            <div className="work-section-top">
                <p className="primary-subheading">Chứng thực</p>
                <h1 className="primary-heading">Những gì họ nói</h1>
